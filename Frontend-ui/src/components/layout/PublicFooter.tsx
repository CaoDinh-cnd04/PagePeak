      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/#huong-dan" className="hover:text-white transition">Tài liệu hướng dẫn</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/#landing-page" className="hover:text-white transition">Landing Page</Link></li>
              <li><Link to="/#website" className="hover:text-white transition">Website Builder</Link></li>
              <li><Link to="/#ecommerce" className="hover:text-white transition">Ecommerce</Link></li>
              <li><Link to="/#automation" className="hover:text-white transition">Automation</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/#tuyen-dung" className="hover:text-white transition">Tuyển dụng</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-10 pt-8 border-t border-slate-700 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm">
            <Link to="/#dieu-khoan" className="hover:text-white transition">Điều khoản sử dụng</Link>
            <Link to="/#bao-mat" className="hover:text-white transition">Chính sách bảo mật</Link>
          </div>
        </div>
      </div>
    </footer>
