...
import { customersApi, workspacesApi, type CustomerItem } from "@/lib/shared/api";
              ...
              <tr key={c.id} className="border-b border-slate-50 dark:border-slate-800 last:border-0 hover:bg-slate-50 dark:hover:bg-slate-800/50">
                ...
                <td className="px-5 py-3">
                  <div className="flex items-center gap-1 justify-end">
                    <button type="button" onClick={() => openEdit(c)} className="p-2 rounded-lg text-slate-400 hover:text-primary-600 hover:bg-slate-50 dark:hover:bg-slate-800 transition"><Pencil className="w-4 h-4" /></button>
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-8">
            ...
            <label className={`flex flex-col items-center gap-3 p-8 border-2 border-dashed rounded-xl cursor-pointer transition ${
              importing ? "border-primary-300 bg-primary-50 dark:border-primary-700 dark:bg-primary-900/20" : "border-slate-300 dark:border-slate-700 hover:border-primary-400 hover:bg-primary-50/50 dark:hover:bg-primary-900/10"
            }`}>
              <Upload className={`w-8 h-8 ${importing ? "text-primary-400 animate-pulse" : "text-slate-400"}`} />
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div>
                <p className="text-2xl font-bold text-primary-600">{groups.length}</p>
