          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
            ...
            <div className="px-6 pb-6">
              <div className="flex items-end gap-4 -mt-10 mb-6">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 text-white flex items-center justify-center text-2xl font-bold ring-4 ring-white dark:ring-slate-900 shrink-0">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 border border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm"
                  />
                </div>
                <div>
              ...
              <div className="flex justify-end mt-6 pt-4 border-t border-slate-100 dark:border-slate-800">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition disabled:opacity-50"
                >
                  {profileSaving ? (
            ...
            <div className="space-y-4 max-w-md">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 pr-10 border border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm"
                  />
                  <button
                    type="button"
              ...
              <div className="pt-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {pwSaving ? (
                    <span className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                  ) : (
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <button type="button" className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition">
                <Users className="w-4 h-4" />
                {t("settings.inviteMember")}
              </button>
            </div>
            <div className="border border-slate-200 dark:border-slate-800 rounded-lg overflow-hidden">
              <div className="flex items-center gap-4 p-4 bg-indigo-50 dark:bg-indigo-500/5 border-b border-indigo-100 dark:border-indigo-500/10">
        ...
        <div className="space-y-6">
          {planLoading ? (
            ...
            <>
              {/* Current plan */}
              <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
                <div className="bg-gradient-to-r from-indigo-500 via-violet-500 to-purple-500 px-6 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
            ...
            <div className="text-center py-12">
              ...
              <button type="button" onClick={loadPlan} className="mt-3 text-sm text-indigo-600 hover:underline">
                {t("settings.retry")}
              </button>
            </div>
          )}
                ...
                {sessions.map((s, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center gap-4 p-4 rounded-lg border transition ${
                        s.isExpired
                          ...
                          : isCurrent
                          ? "bg-indigo-50 dark:bg-indigo-500/5 border-indigo-200 dark:border-indigo-500/20"
                    ...
                    >
                      ...
                      >
                        {info.device === "mobile" ? (
                          <Smartphone className={`w-5 h-5 ${isCurrent ? "text-indigo-600" : "text-slate-400"}`} />
                        ) : (
                          <Monitor className={`w-5 h-5 ${isCurrent ? "text-indigo-600" : "text-slate-400"}`} />
                        )}
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {isCurrent && (
                            <span className="px-2 py-0.5 bg-indigo-100 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 text-[10px] font-bold rounded-full uppercase">
                              {t("settings.current")}
                            </span>
                          )}
                          {s.isExpired && (
