...
import { reportsApi, workspacesApi, pagesApi, ordersApi, type ReportsOverview, type PageItem, type OrderItem } from "@/lib/api";
...
const STAT_CARDS: StatCard[] = [
  { label: "Tổng trang", key: "totalPages", icon: <FileText className="w-6 h-6" />, bg: "bg-indigo-50 dark:bg-indigo-500/10", text: "text-indigo-600 dark:text-indigo-400" },
...
function ReportsInner() {
  ...
  const switchTab = (t: TabKey) => {
    router.replace(t === "overview" ? "/dashboard/reports" : `/dashboard/reports?tab=${t}`, { scroll: false });
  };
