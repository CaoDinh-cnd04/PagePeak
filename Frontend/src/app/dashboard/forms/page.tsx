            ...
            >
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1">
                  ...
                  {form.emailNotify && (
                    <span className="px-2 py-0.5 text-[10px] font-semibold rounded-full bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400">
                      Email notify
                    </span>
                  )}
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <div
                  className={`relative w-10 h-6 rounded-full transition ${emailNotify ? "bg-indigo-600" : "bg-slate-300 dark:bg-slate-700"}`}
