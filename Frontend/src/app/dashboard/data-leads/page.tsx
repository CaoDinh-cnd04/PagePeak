...
import { leadsApi, workspacesApi, pagesApi, type LeadItem, type PageItem } from "@/lib/api";
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="px-3 py-2 border border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
        >
                  ...
                  <tr key={l.id} className="border-b border-slate-50 dark:border-slate-800 last:border-0 hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-1">
                        <button type="button" onClick={() => setDetailLead(l)} className="p-2 rounded-lg text-slate-400 hover:text-indigo-600 hover:bg-slate-50 dark:hover:bg-slate-800 transition">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          ...
          >
            ...
            <div className="flex justify-end mt-6">
              <button type="button" onClick={() => setDetailLead(null)} className="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition">
                Đóng
              </button>
            </div>
          </div>
