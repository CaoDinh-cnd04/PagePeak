...
export default function MediaPanel({
  ...
  return (
    ...
    >
      {/* Drag overlay */}
      {dragOver && (
        <div className="absolute inset-0 z-50 bg-indigo-500/10 border-2 border-dashed border-indigo-500 rounded-lg flex items-center justify-center backdrop-blur-sm">
          <div className="text-center">
            <CloudUpload className="w-12 h-12 text-indigo-500 mx-auto mb-2" />
            <p className="text-sm font-semibold text-indigo-600">Thả file vào đây</p>
          ...
          <>
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded-lg transition"
              >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-slate-700 dark:text-slate-200"
              />
            </div>
          </>
        )}
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  {STOCK_IMAGES
                    ...
                    <button
                      ...
                      className="group relative rounded-lg overflow-hidden border border-slate-200 hover:border-indigo-400 transition-all hover:shadow-md cursor-pointer"
                    >
                      ...
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-all flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <span className="px-3 py-1.5 bg-indigo-600 text-white text-[10px] font-bold rounded-full shadow-lg">+ Chèn ảnh</span>
                      </div>
                ...
                <div className="space-y-2">
                  {STOCK_VIDEOS
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-2.5 p-2 rounded-lg border border-slate-200 hover:border-indigo-400 hover:bg-indigo-50/50 transition group text-left"
                    >
                      ...
                      <span className="text-[9px] font-bold text-indigo-600 opacity-0 group-hover:opacity-100 shrink-0">+ Chèn</span>
                    </button>
                  ))}
                </div>
              </>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <button
              type="button"
              onClick={() => fileInputRef.current?.click()}
              className="mt-3 inline-flex items-center gap-1.5 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium rounded-lg transition"
            >
        ...
        <div className="px-3 py-2.5 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 shrink-0">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-[11px] font-semibold rounded-md transition whitespace-nowrap"
            >
              Chèn vào trang
            </button>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-2xl w-full mx-4 overflow-hidden" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-4">
              <div className="relative bg-slate-100 dark:bg-slate-800 rounded-lg overflow-hidden flex items-center justify-center" style={{ maxHeight: "400px" }}>
                {isVideo(previewItem.contentType) ? (
                  ...
                  <Image
                    ...
                    width={previewItem.width ?? 600}
                    height={previewItem.height ?? 400}
              ...
              <div className="mt-3 grid grid-cols-2 gap-x-4 gap-y-1.5 text-xs">
                ...
                <div className="text-indigo-600 truncate cursor-pointer hover:underline" onClick={() => handleCopyUrl(previewItem)}>
